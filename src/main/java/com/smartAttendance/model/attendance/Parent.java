...
public class Parent {
	...
	@Column(name = "familly_role")
	private String famillyRole;
	...
	@Column(name = "assigned_to_student")
	private String assignedToSttudent;
	...
	public String getFamillyRole() {
		return famillyRole;
	}

	public void setFamillyRole(String famillyRole) {
		this.famillyRole = famillyRole;
	}
	...
	public String getAssignedToSttudent() {
		return assignedToSttudent;
	}

	public void setAssignedToSttudent(String assignedToSttudent) {
		this.assignedToSttudent = assignedToSttudent;
	}
