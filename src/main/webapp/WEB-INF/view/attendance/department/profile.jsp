...
<div class="container-fluid">
		...
		<nav class="navbar navbar-default">
			<div>
				<div class="navbar-header">
					<a class="navbar-brand" href="#">${map.lb_departmentName }</a> <br>
					<div class="sub-header">Department Profile</div>
				</div>
			</div>
		</nav>
	</div>
	<div class="row">
		<ul class="breadcrumb margin-top--20">
			...
			<li class="active"><c:out value="${map.department_name }"/></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-8">
			<div class="sa-card">
				<div class="sa-card-header bg-cyan">
					<div class="pull-left header-title">Subjects</div>
				...
				<div class="sa-card-body">
					<div class="button-group">
						<gts:Button name="<i class='fa fa-book'></i><br>Web design"
							cssClass="btn btn-user" />
						<gts:Button name="<i class='fa fa-book'></i><br>web development"
							cssClass="btn btn-user" />
						<gts:Button name="<i class='fa fa-book'></i><br>mathematics 2"
							cssClass="btn btn-user" />
						<gts:Button
							name="<i class='fa fa-book'></i><br>Discrete Mathematics"
							cssClass="btn btn-user" />
					</div>
				</div>
			</div>
			<div class="sa-card">
				...
				<div class="sa-card-footer">This has no Assessment</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="sa-card">
				<div class="sa-card-header">
					...
					<div class="pull-right">
						<button name="Edit" class="btn btn-edit" data-toggle="modal" data-target="#edit_general_info">Edit</button>
					</div>
					
					<div class="modal fade" role="dialog" id="edit_general_info">
						<div class="modal-dialog">
							<div class="modal-content">
								<gts:AjaxForm dataHandler="" action="${PageContext.request.ContextPath }updatedept">
								
									<div class="modal-header font-size-18">
										<div class="pull-left">
											Edit Department Info
											<input name="id" style="display: none" value="${map.id }"/>
										</div>
										<div class="pull-right">
											...
											<div class="form-horizontal">
												<div class="form-group hr-dashed">
													<div class="col-md-3 label-align padding-right-0">
														<label class="control-label" labelFor="department_code" name="Department Code">Department Code</label>
													</div>
													<div class="col-md-7"> 
														<input name="department_code" value="${map.department_code }" class="form-control">
													</div>
												</div>
												<div class="form-group hr-dashed">
													<div class="col-md-3 label-align padding-right-0">
														<label class="control-label" labelFor="department_name" name="Description">Descripton</label>
													</div>
													<div class="col-md-7"> 
														<input name="department_name" value="${map.department_name }" class="form-control">
													</div>
												</div>
											</div>
										</div>
					...
					<div class="form-horizontal">
						<div class="form-group bg-f9 padding-4">
							...
							<div class="col-md-7 padding-top-8">
								<c:out value="${map.department_name }"/>
							</div>
						</div>
						<div class="form-group padding-4">
							<div class="col-md-3 label-align padding-right-0">
								<gts:Label name="${map.lb_departmentCode }"
									labelFor="department_code" />
							</div>
							<div class="col-md-7 padding-top-8">
								<c:out value="${map.department_code }" />
							</div>
						</div>
