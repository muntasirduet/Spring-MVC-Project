...
<div class="container-fluid">
	<div class="row">
		<div>
			<div class="pull-left">
				...
				<div>Manage all your departments right here</div>
			</div>
		</div>
	</div>
	<div class="col-md-8 department-list">
		<div class="sa-card department-list-firstCard">
			<div class="sa-card-header">
				<div>
					<span>Filter</span> Departments
				</div>
				...
				<div class="col-md-5 btn-group">
					<div class="dropdown pull-left">
						<button class="btn btn-default" data-toggle="dropdown">
							<span>Department Filter</span> <span class="caret"></span>
						</button>
					</div>
					<div class="dropdown pull-left">
						<button class="btn btn-default" data-toggle="dropdown">
		...
		<div class="sa-card department-list-secondCard">
			<!-- <div class="sa-card-header">
				<div>
			...
			<div class="sa-card-body secondCard-body">
				<div>
					<div>
						...
						<div class="pull-left">
							<div>
								...
								<div class="btn-group">
									<gts:Button name="Dept" cssClass="btn btn-default" />
								...
								<div>
									<span>4</span> <span class="fa fa-user"></span>
								</div>
							</div>
					...
					<div>
						...
						<div class="pull-left">
							<div>
								...
								<div>
									<span>8</span> <span class="fa fa-user"></span>
								</div>
							</div>
					...
					<div>
						...
						<div class="pull-left"
							style="width: 60%; text-align: right; margin-top: 20px; padding-right: 15px;">
	...
	<div class="col-md-4 add-class">
		<div class="sa-card">
			<div class="sa-card-header">
				<gts:Button
					name="<span class='glyphicon glyphicon-plus'></span><span>Add Department</span>" />
			</div>
			<div class="sa-card-body">
				<div>
					<div class="col-md-3">
						<gts:Label name="${map.lb_departmentName }"
							labelFor="department_name" />
					</div>
					<div class="col-md-9">
						<gts:TextBox name="department_name" cssClass="form-control" />
					</div>
				</div>
				<!-- <div>
					<div class="col-md-3">
			...
			<div class="sa-card-footer">
				<div>
					<gts:Submit name="Add Department" cssClass="btn btn-default" />
				</div>
			</div>
		</div>
	</div>
...
.department-list-secondCard>.sa-card-body>div>div:nth-child(1)>div:last-child
	{
	width: 60%;
	text-align: right;
	margin-top: 20px;
...
.department-list-secondCard>.sa-card-body>div>div>div:first-child>div>button
	{
	border-radius: 50%;
	border: none;
	color: white;
...
.department-list-secondCard>.sa-card-body>div>div:nth-child(1)>div:first-child>div
	{
	margin-top: 15px;
	margin-left: 15px;
}
...
.department-list-firstCard>.sa-card-body>div:last-child>button {
	color: #FFF;
	background-color: #ff9900;
}

.department-list-firstCard>.sa-card-body>div:last-child>button>span:first-child
	{
	margin-right: 5px;
}

.department-list-firstCard>.sa-card-body>div:first-child>div:first-child>button:first-child
	{
	color: #FFF;
	margin-right: 2px;
	background-color: #60e0f1;
...
.department-list-firstCard>.sa-card-body>div:first-child>div:last-child>button:last-child
	{
	margin-left: 2px;
	background-color: #f9f9f9;
}

.department-list-firstCard>.sa-card-body>div:first-child {
	float: left;
	margin-left: 35px;
}

.department-list-firstCard>.sa-card-body>div:last-child {
	float: left;
	margin-left: 10px;
}

.department-list-firstCard>.sa-card-header>div {
	float: left;
	font-size: 16px;
}

.department-list-firstCard>.sa-card-header>div:last-child {
	font-size: 13px;
	float: right;
}

.department-list-firstCard>.sa-card-header>div>span:first-child {
	font-weight: bold;
}

.department-list-secondCard>.sa-card-body>div>div {
	float: left;
	display: inline-block;
	width: 30%;
	margin: 5px 12px;
