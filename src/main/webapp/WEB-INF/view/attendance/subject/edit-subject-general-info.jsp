...
<title>edit Subject general info</title>
<div>
					...
					<div class="form-horizontal">
						<div class="form-group hr-dashed">
							<div class="col-md-3 label-align padding-right-0">
								<gts:Label name="${map.lb_subjectName }" labelFor="subject_name" cssClass = "control-label"/>
							</div>
							<div class="col-md-7"> 
								<input type name="subject_name" value="${map.subject_name }" class="form-control" placeholder="Subject Name" >
							</div>
						</div>
						<div class="form-group hr-dashed">
							<div class="col-md-3 label-align padding-right-0">
								<gts:Label name="${map.lb_subjectCode }" labelFor="subject_code" cssClass = "control-label"/>
							</div>
							<div class="col-md-7"> 
								<input type name="subject_code" value="6611" class="form-control" placeholder="Subject Code" >
							</div>
						</div>
					</div>
				</div>
