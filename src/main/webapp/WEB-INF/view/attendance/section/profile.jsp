...
<title>edit Section Profile</title>
<div class="container-fluid">
	<div class="row">
		<nav class="navbar navbar-default">
			<div>
				<div class="navbar-header">
					<a class="navbar-brand" href="#"><c:out value="${map.section_name }"/></a> <br>
					<div class="sub-header">Section Profile</div>
				</div>
			</div>
		</nav>
	</div>
	<div class="row">
		<ul class="breadcrumb margin-top--20">
			...
			<li class="active"><c:out value="${map.section_name }"/></li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-8">
		...
		<div class="col-md-4">
			<div class="sa-card">
				<div class="sa-card-header">
					...
					<div class="pull-right">
						<button type="button" class="btn btn-edit" data-toggle="modal" data-target="#edit_general_info">Edit</button>
					</div>
					<div class="modal fade" role="dialog" id="edit_general_info">
						<div class="modal-dialog">
							<div class="modal-content">
								<gts:AjaxForm dataHandler="" action="${PageContext.request.Contextpath }updatesect">
										...
										<div class="container-fluid">
											<div class="form-horizontal">
												<div class="form-group hr-dashed">
													...
													<div class="col-md-7"> 
														<input name="section_name" value="Section A" class="form-control" placeholder="Section Name" >
													</div>
												</div>
											</div>
										</div>
				...
				<div class="sa-card-body">
					<div class="form-horizontal">
						<div class="form-group bg-f9 padding-4">
							<div class="col-md-3 label-align padding-right-0">
								<gts:Label name="Description" labelFor="department_name" />
							</div>
							<div class="col-md-7 padding-top-8">
								<c:out value="${map.section_name}"/>
							</div>
						</div>
					</div>
				</div>
